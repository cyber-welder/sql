...
-- ---------------------------------------------------------------------------------------------------------
-- ОТВЕТ на Операции. Задание 3
-- ---------------------------------------------------------------------------------------------------------
SELECT *, value>0 as pos FROM storehouses_products ORDER BY pos DESC, value;
-- или
...
-- ---------------------------------------------------------------------------------------------------------
-- ОТВЕТ на Агрегация. Задание 2
-- ---------------------------------------------------------------------------------------------------------
SELECT * FROM users;

SELECT
	DATE_FORMAT(DATE(CONCAT(YEAR(NOW()), '-', MONTH(birthday_at), '-', DAYOFMONTH(birthday_at))), '%W') AS day_of_week,
	COUNT(*) AS count_birthdays
FROM
	users
GROUP BY
	day_of_week
ORDER BY
	count_birthdays DESC;
-- --------------------------------------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------------------------------------
-- ОТВЕТ на Агрегация. Задание 3
-- ---------------------------------------------------------------------------------------------------------
-- в таблице catalogs нет столбцов для подсчета произведения значений, посчитал столбец id
